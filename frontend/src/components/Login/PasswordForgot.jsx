        ...
        <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center px-6 py-8">
            <div className="w-full bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 max-w-2xl">
                <div className="p-6 space-y-6">
                    <h1 className="text-2xl font-bold text-center text-gray-900 dark:text-white">Mot de passe oublié ?</h1>
                    <p>Entrez votre adresse e-mail ci-dessous afin de recevoir un lien pour ré-initaliser votre mot de passe.</p>
                    <Formik
                        initialValues={{
                            email: "",
                        }}
                    ...
                    <div className="flex justify-center mb-3">
                        <p>Revenir à la page de <Link className="text-color" to="/connexion"  onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
                        >connexion</Link></p>
                    </div>
                </div>
            </div>
