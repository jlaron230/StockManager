...
const AddProduct = () => {
    ...
    const validationSchema = Yup.object({
        ...
        seuil: Yup.number().min(0, "Minimum 0").required("Champ requis"),
                    ...
                    {() => (
                        <Form className="w-full flex flex-wrap">
                            <div className="max-w-3xl p-6 bg-white rounded-2xl shadow">
                                ...
                                {/* Seuil */}
                                <div className="mb-4">
                                    <label htmlFor="seuil" className="block font-medium">Seuil minimal</label>
                                    <Field name="seuil" type="number" className="input w-full border p-2" />
                                    <ErrorMessage name="seuil" component="div" className="text-red-600 text-sm" />
                                </div>
                            ...
                            <div className="max-w-3xl p-6 bg-white rounded-2xl shadow">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ErrorMessage name="quantité_en_stock" component="div" className="text-red-600 text-sm" />
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ErrorMessage name="prix_unitaire" component="div" className="text-red-600 text-sm" />
                                </div>

                                {/* Date de péremption */}
                                <div className="mb-4">
                                    <label htmlFor="date_peremption" className="block font-medium">Date de péremption</label>
                                    <Field name="date_peremption" type="date" className="input w-full border p-2" />
                                    <ErrorMessage name="date_peremption" component="div" className="text-red-600 text-sm" />
                                </div>

                                {/* Condition d'achat */}
                                <div className="mb-4">
                                    <label htmlFor="condition_achat" className="block font-medium">Condition d'achat</label>
                                    <Field name="condition_achat" type="text" className="input w-full border p-2" />
                                    <ErrorMessage name="condition_achat" component="div" className="text-red-600 text-sm" />
                                </div>
                                    ...
                                    <div className="flex gap-4 mb-4">
                                        {images.map((img, index) => (
                                            <div key={index} className="relative">
                                                <img src={URL.createObjectURL(img)} alt={`img-${index}`} className="w-24 h-24 object-cover rounded" />
                                                <button
                                                    type="button"
