...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/components/CustomDrawerContent` | `/components/ProductBarChart` | `/context/AuthContext` | `/hooks/useRegisterPushToken` | `/navigation/DrawerNavigator` | `/navigation/` | `/screens/AjouterProduitScreen` | `/screens/DashboardScreen` | `/screens/LoginScreen` | `/screens/PasswordResetRequestScreen` | `/screens/ProductDetailScreen` | `/screens/ProductListScreen` | `/screens/UserProfileScreen`;
  // prettier-ignore
